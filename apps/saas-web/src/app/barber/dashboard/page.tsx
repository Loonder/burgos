                ...
                <FeatureGate
                    ...
                    fallback={
                        <div className="bg-white/5 border border-white/5 rounded-xl p-6 text-center">
                            <h3 className="text-lg font-bold text-white mb-2">Desbloqueie o Modo Guerra ⚔️</h3>
                            <p className="text-burgos-accent/60 text-sm mb-4">Competições e Metas estão disponíveis no plano WAR.</p>
                            <button className="bg-burgos-primary text-burgos-dark font-bold px-4 py-2 rounded-lg text-sm">Fazer Upgrade</button>
                        </div>
                    }
                >
                    <div>
