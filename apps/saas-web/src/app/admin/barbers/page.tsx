...
export default function BarbersPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setIsFormOpen(false);
            fetchBarbers();
            setFormData({ name: '', email: '', phone: '', commission_rate: 40, password: 'password123' });
        } catch (error) {
            alert('Error creating barber');
        }
    };
        ...
        <div className="space-y-6">
            ...
            {isFormOpen && (
                <div className="glass-dark p-6 rounded-2xl border border-white/10 animate-fade-in-down">
                    <h3 className="text-white font-bold mb-4">Novo Barbeiro</h3>
